...
static const PsxrecompCodegenHostConfig kCodegenConfig = {
    .display_name = "Wipeout2K97XL",
    .project_root_env = "WIPEOUT2K97XL_PROJECT_ROOT",
    .build_dir_env = "WIPEOUT2K97XL_BUILD_DIR",
    .force_setup_env = "WIPEOUT2K97XL_FORCE_SETUP",
